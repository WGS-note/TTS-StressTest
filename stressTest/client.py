...
# async def listen_to_voice(text, idx, server_ip='localhost', server_port=9999, rate=24000, output_file="./out.wav"):
...
#     tasks = [limited_listen_to_voice(idx, text) for idx, text in enumerate(test_reqs)]
#     start_time = time.time()
#     await asyncio.gather(*tasks)
#     print("[DEBUG] 总耗时:", time.time() - start_time)
